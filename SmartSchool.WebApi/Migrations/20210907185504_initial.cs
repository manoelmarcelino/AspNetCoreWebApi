    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "Lauro", null, null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "DisciplinaId", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 2, 0, "Roberto", null, null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "DisciplinaId", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 3, 0, "Ronaldo", null, null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "DisciplinaId", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 4, 0, "Rodrigo", null, null });

            migrationBuilder.InsertData(
                table: "Professores",
                columns: new[] { "Id", "DisciplinaId", "Nome", "Sobrenome", "Telefone" },
                values: new object[] { 5, 0, "Alexandre", null, null });
